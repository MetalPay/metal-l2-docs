...
<Callout type="info">
  ...
  A claim about the state of one chain made on another chain. For instance, I can claim that in Metal L2 I have burned my tokens with the intent to withdraw those tokens back to L1.
</Callout>
