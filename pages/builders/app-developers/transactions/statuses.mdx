---
title: Transaction statuses on Metal L2
lang: en-US
description: Learn about the statuses transactions can have on Metal L2.
---

# Transaction statuses on Metal L2

Transactions on Metal L2 can have a number of different statuses depending on where a transaction is in the process of being included in the blockchain.
...
Once a block has been finalized it is guaranteed to be included in the Metal L2 blockchain.
