...
title: JSON-RPC API
lang: en-US
description: Learn about the different Metal L2 components with an RPC API.
---
...
There are several Metal L2 components with an RPC API, which are reviewed in this guide.
