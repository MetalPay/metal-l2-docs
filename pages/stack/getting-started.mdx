...
The OP Stack is the set of software that powers Metal L2 — currently in the form of the software behind Metal L2 and eventually in the form of the Optimism Superchain and its governance.
