...
**The OP Stack is the standardized, shared, and open-source development stack that powers Metal L2, maintained by the Optimism Collective.**
...
## The OP Stack powers Metal L2

The OP Stack is the set of software that powers Metal L2 — currently in the form of the software behind OP Mainnet and eventually in the form of the Optimism Superchain and its governance.
...
The OP Stack is *all* of the software that powers Metal L2.
...
If you're interested in experimenting with the OP Stack, check out [the OP Stack Hacks section of this site](/builders/chain-operators/hacks/overview).
...
As the Superchain begins to take shape, the OP Stack can evolve alongside it, to include the message-passing infrastructure that allows different chains to interoperate seamlessly.
