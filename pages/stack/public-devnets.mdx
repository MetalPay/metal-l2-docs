...
lang: en-US
description: Learn about alphanets and betanets - the development networks for testing upcoming OP Stack releases. 
---
...
Betanets are used to solidify the scope of the next hardfork before deploying to the production testnet (e.g., Metal L2 Testnet).
